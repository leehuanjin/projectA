...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/SWINBURNE.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-dgrey mt-4x">Forgot Password</h1>
...
{ ?>
					...
					<?php }  ?>
						...
						<div class="text-center text-light">
                            <h3><a href="index.php" class="text-yellow">Sign in?</a></h3>
						</div>
					</div>
				</div>
			</div>
