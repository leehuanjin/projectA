...
$query="update  userRegistration set studentId=?,firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updateDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$studentid,$fname,$mname,$lname,$gender,$contactno,$udate,$aid);
$stmt->execute();
...
Last update : &nbsp; <?php echo $row->updateDate;?> 
</div>
